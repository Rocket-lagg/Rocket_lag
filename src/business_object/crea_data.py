    ...
    def process_players(self, match_data, couleur, ligue, region, stage, date):
        ...
        try:
            ...
            for j in range(3):  # Assume 3 players per team
                if j < len(match_data[couleur]['players']):  # Vérifie si l'index j existe
                    ...
                    joueur_data = {
                        ...
                        "goal_participation": round(joueur_stats['stats']['advanced'].get('goalParticipation', 0) if joueur_core.get('goalParticipation', 0) else 0, 2),
            ...
            print(f"Aie! Une clé est manquante : {e}")
