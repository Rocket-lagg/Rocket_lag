...
# On définit ici la classe tournoi avec 3 fonctionnalitées et qui va permettre de gérer
# les tournois qui seront crées par les utilisateur (uniquement).
# Pour les matchs officiels, cela se fera directement via Api.
...
class Tournoi:
    ...
    def suivre_resultats(self, equipe1, equipe2, score1, score2):
        ...
        print(
            f"Match joué: {equipe1.nom} {score1} - {equipe2.nom} {score2}. Gagnant: {gagnant.nom}"
        )
        return gagnant
